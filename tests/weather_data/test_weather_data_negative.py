...
def test_invalid_city(api_client):
    ...
    response = api_client.get("data/2.5/weather", params={"q": "ZzzZZZ"})
...
@pytest.mark.negative
def test_nothing_geocode(api_client):

    response = api_client.get("data/2.5/weather") # Example of invalid coordinates
