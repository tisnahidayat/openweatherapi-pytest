...
def test_setup(api_client):
    ...
    assert isinstance(response["main"]["temp"], float), "Response 'main.temp' should be a integer"
    assert isinstance(response["wind"]["speed"], (float, int)), "Response 'wind.speed' should be a float"
