...
@pytest.mark.positive
def test_forecast_zip_code(api_client):

    response = api_client.get("data/2.5/forecast", params={"id": 1621177})
...
@pytest.mark.positive
def test_forecast_coordinate(api_client):

    response = api_client.get("data/2.5/forecast", params={"lat": 38.8951, "lon": -77.0364})
